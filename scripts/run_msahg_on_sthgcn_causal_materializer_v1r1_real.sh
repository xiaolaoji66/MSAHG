...
output_root=/mnt/data4t/wyh/msahg_runs/msahg_on_sthgcn_causal_materializer_v1r1_real-d7e2706

registry="$audit_root/reproduction/MSAHG_ON_STHGCN_CAUSAL_MATERIALIZER_V1R1_REAL_RUNTIME_REGISTRY.json"
runtime_authority="$audit_root/reproduction/MSAHG_ON_STHGCN_CAUSAL_MATERIALIZER_V1R1_REAL_RUNTIME_AUTHORITY.json"
...
auditor="$audit_root/reproduction/audit_msahg_on_sthgcn_causal_materializer_v1r1_real.py"
authority_sha=6b72ebdc704312a8703e6bca8184de1843e27f7372182393adace65728bb2ba0
...
"$python_bin" -m unittest -v \
  tests.test_msahg_on_sthgcn_causal_materializer_v1r1_real \
  tests.test_msahg_on_sthgcn_causal_materializer_v1r1_real_governance
...
print("MSAHG_CAUSAL_REAL_DECISION={}".format(receipt["decision"]))
