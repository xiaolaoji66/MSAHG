#!/usr/bin/env python3
"""Independent audit of real V1R1 original-split provenance outputs."""
...
def main(argv=None):
    ...
    receipt = {
        "schema": "msahg.sthgcn-sample-materializer-v1r1-independent-audit.v1",
        "decision": "PASS" if root_ok and summary_ok and all(item["pass"] for item in results) else "FAIL",
